...
\section{Conclusion}
This thesis investigated the use of Large Language Models for high-level planning and replanning in multi-drone systems.
The goal was to bridge the gap between natural-language mission descriptions and executable mission schedules, 
while enabling the system to adapt when assigned subtasks become infeasible during execution.
...
the planner may still occasionally produce malformed JSON files, missing fields, or schedules that violate system constraints.
