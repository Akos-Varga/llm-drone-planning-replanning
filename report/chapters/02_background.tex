...
Taken together, these works demonstrate the growing capabilities of LLM-based multi-agent systems in task decomposition, 
coordination, scheduling, and adaptive replanning.
However, they also reveal a key limitation: existing approaches often treat replanning as a reactive update mechanism 
rather than as part of an explicit scheduling framework.
While several systems can adapt to environmental changes or agent feedback, they typically do not generate explicit schedules 
that can be inspected, evaluated, and updated when execution conditions change.
