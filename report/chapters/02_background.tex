...
However, the generated plans are primarily the result of dialogue-based coordination and are not represented as explicit, time-parameterized schedules.
...
The replanning process is therefore mainly event-driven and reactive, rather than being connected to a time-parameterized schedule that can be evaluated, updated, and compared against an optimization baseline.
...
it does not produce explicit, time-parameterized schedules that can be directly inspected or executed. 
...
While several systems can adapt to environmental changes or agent feedback, they typically do not generate time-parameterized schedules 
